...
do_install:append () {
	install -m 644 ${WORKDIR}/sources-unpack/swupdate.cfg ${D}/${sysconfdir}
	install -m 644 ${WORKDIR}/sources-unpack/swu_public.pem ${D}/${sysconfdir}

	install -m 644 ${WORKDIR}/sources-unpack/swupdate-sysrestart.service ${D}${systemd_system_unitdir}
